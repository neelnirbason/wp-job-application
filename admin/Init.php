...
class Init {
	...
	final public function run( Loader $loader ): void {
		$loader->add_action( 'admin_enqueue_scripts', array( $this, 'register_scripts' ) );
	...
	final public function register_scripts(): void {
		wp_register_style( 'wp-job-application', plugin_dir_url( __FILE__ ) . 'assets/styles.css', array(), '1.0.0' );
		wp_register_script(
			'wp-job-application',
